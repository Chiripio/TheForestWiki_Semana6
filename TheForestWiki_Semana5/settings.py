...
# ✅ Inicializa Oracle Client (instant client dentro de oracle_wallet)
if any(cmd in sys.argv for cmd in ['runserver', 'shell', 'migrate', 'makemigrations', 'dbshell']):
    ...
    if os.path.exists(client_dir):
        ...
        os.environ['TNS_ADMIN'] = wallet_dir  # Para que reconozca tnsnames.ora
        
        print("⏳ Inicializando cliente Oracle desde settings.py...")
        print("📁 LIB_DIR usado:", client_dir)
...
# ✅ Conexión limpia a Oracle usando oracledb + wallet en oracle_wallet
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.oracle',
        'NAME': 'edu_high',  # ← Alias definido en oracle_wallet/network/admin/tnsnames.ora
        'USER': 'forestwiki',
